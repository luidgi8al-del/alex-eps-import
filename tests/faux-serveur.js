...
(function () {
  ...
  const DONNEES = {
    ...
    epi_inspections: [],
    unss_students: [{ id: "us-1", user_id: "prof-test", institution_id: "etab-1", first_name: "Lea", last_name: "Martin", category: "MINIME", sex: "F", division: "3e6", deleted: false, updated_at: MAINTENANT }],
