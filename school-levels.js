...
async function openSettings() {
  const errors=[];
  await Promise.all([refreshPeriodSettings().catch(e=>errors.push(e.message)),refreshTeacherProfile().catch(e=>errors.push(e.message)),loadInstitution().catch(e=>errors.push("Établissement non actualisé."))]);
